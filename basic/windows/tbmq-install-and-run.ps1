...
if (Test-Path "docker-compose.yml") {
    ...
    Invoke-WebRequest -Uri "https://raw.githubusercontent.com/thingsboard/tbmq-pe-docker-compose/release-2.2.0/basic/docker-compose.yml" -OutFile "docker-compose.yml"
}
